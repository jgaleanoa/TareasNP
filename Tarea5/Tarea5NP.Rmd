...
Como $n=m=20$ el cuantil $W_{1-\alpha}$ se alla en la tabla A19 de Conover.
...
```
Además el $p_{valor}=0.03968254$ con el cual, a un nivel $\alpha=0.05$ se sigue rechazando $H_0$.
